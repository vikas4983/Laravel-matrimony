            ...
            <div id="sidebar" class="sidebar sidebar-with-footer">
                ...
                <div class="sidebar-left" data-simplebar style="height: 100%;">
                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        <li class="active">
                            <a class="sidenav-item-link" href="{{ url('admin/admin_deshboard') }}">
                        ...
                        <li>
                            <a class="sidenav-item-link" href="{{ url('admin/user_deshboard') }}">
                                    ...
                                    <li class="has-sub">
                                        ...
                                        <ul class="collapse" id="tables">
                                            <div class="sub-menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('countries.index') }}"><i
                                                            class="mdi mdi-format-list-bulleted"
                                                            style="color: rgb(158,109,226)"></i>List</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('countries.create') }}"><i
                                                            class="mdi mdi-plus-box"
                                                            style="color: rgb(158,109,226)"></i>Create</a>
                                                </li>
                                    ...
                                    <li class="has-sub">
                                        ...
                                        <ul class="collapse" id="icons">
                                            <div class="sub-menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('states.index') }}"><i
                                                            class="mdi mdi-format-list-bulleted"
                                                            style="color: rgb(158,109,226)"></i>List</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('states.create') }}"><i
                                                            class="mdi mdi-plus-box"
                                                            style="color: rgb(158,109,226)"></i>Create</a>
                                                </li>
                                    ...
                                    <li class="has-sub">
                                        ...
                                        <ul class="collapse" id="religions">
                                            <div class="sub-menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('religions.index') }}"><i
                                                            class="mdi mdi-format-list-bulleted"
                                                            style="color: rgb(158,109,226)"></i>List</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('religions.create') }}"><i
                                                            class="mdi mdi-plus-box"
                                                            style="color: rgb(158,109,226)"></i>Create</a>
                                                </li>
                                    ...
                                    <li class="has-sub">
                                        ...
                                        <ul class="collapse" id="castes">
                                            <div class="sub-menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('castes.index') }}"><i
                                                            class="mdi mdi-format-list-bulleted"
                                                            style="color: rgb(158,109,226)"></i>List</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('castes.create') }}"><i
                                                            class="mdi mdi-plus-box"
                                                            style="color: rgb(158,109,226)"></i>Create</a>
                                                </li>
                        ...
                        <li class="has-sub">
                            <ul class="collapse" id="Employees">
                                <div class="sub-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('employees.create') }}"><i class="mdi mdi-plus-box"
                                                style="color: rgb(158,109,226)"></i> Create</a>
                                    </li>
                                </div>
                            </ul>
                        ...
                        <li class="has-sub">
                            <ul class="collapse" id="Educations">
                                <div class="sub-menu">
                                    <li>
                                        <a href="{{ route('educations.index') }}"><i
                                                class="mdi mdi-format-list-bulleted"
                                                style="color: rgb(158,109,226)"></i>List</a>

                                    </li>
                                    <li>
                                        <a href="{{ route('educations.create') }}"><i class="mdi mdi-plus-box"
                                                style="color: rgb(158,109,226)"></i>Create</a>
                                    </li>
                                </div>
                            </ul>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="collapse" id="Occupations">
                                <div class="sub-menu">
                                    <li>
                                        <a href="{{ route('occupations.index') }}"><i
                                                class="mdi mdi-format-list-bulleted"
                                                style="color: rgb(158,109,226)"></i>List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('occupations.create') }}"><i class="mdi mdi-plus-box"
                                                style="color: rgb(158,109,226)"></i>Create</a>
                                    </li>
                                </div>
                            </ul>
                        ...
                        <li class="has-sub">
                            <ul class="collapse" id="Incomes">
                                <div class="sub-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('incomes.create') }}"><i class="mdi mdi-plus-box"
                                                style="color: rgb(158,109,226)"></i>Create</a>
                        ...
                        <li class="has-sub">
                            <ul class="collapse" id="Plans">
                                <div class="sub-menu">
                                    <li>
                                        <a href="{{ route('plans.index') }}"><i class="mdi mdi-format-list-bulleted"
                                                style="color: rgb(158,109,226)"></i>List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('plans.create') }}"><i class="mdi mdi-plus-box"
                                                style="color: rgb(158,109,226)"></i>Create</a>
                            ...
                            <li class="dropdown user-menu">
                                <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    @if ($activePlan)
                                        ...
                                        <span  style="color: rgb(5, 5, 5); text-decoration: none; font-family:'Karla', 'sans-serif'"
                                            onmouseover="this.style.color='rgb(137,77,217)';"
                                            onmouseout="this.style.color='black';"><i 
                                                class="mdi mdi-chess-queen mr-1" style="color: rgb(5, 5, 5); text-decoration: none;"
                                            onmouseover="this.style.color='rgb(137,77,217)';"
                                            onmouseout="this.style.color='black';"></i>Premium</span>
                                    @else(!$activePlan)
                                        <span class="d-none d-lg-inline-block"><i
                                                class="mdi mdi-chess-queen mr-1"></i>Free</span>
                                    @endif

                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a class="dropdown-link-item" href="{{ route('admin_auth.index') }}">
                            ...
                            <li class="dropdown user-menu">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="dropdown-footer">
                                        <form id="admin_logout-form" action="{{ url('admin_logout') }}"
                                            method="post">
                                            @csrf
