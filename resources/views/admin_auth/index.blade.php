                        ...
                        <div class="profile-avata">
                            @if ($admin->image)
                                <img class="rounded-circle" src="{{ asset('storage/admin/image/' . $admin->image) }}"
                                    alt="Avata Image" style="width: 200px; height: 200px; overflow: hidden; border-radius: 50%;">
                            @else(! $admin->image)
                        ...
                        <a class="nav-link" href="user-activities.html">Activities</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="user-profile-settings.html"><i
                                        class="mdi mdi-settings-outline mr-1"></i>Setting</a>
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <a class="nav-link " href="user-profile-settings.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ url('http://localhost:8000/admin/plans/plan') }}">
                                            <i class="mdi mdi-currency-usd mr-1" style="color:rgb(158,109,224) "></i>
                                            Planing
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" button type="button" data-toggle="modal" data-target="#exampleModal">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ url('admin_image_delete', $admin->id) }}"><button
                                                                type="button"
                            ...
                            <div class="accordion" id="accordionOne">
                                <div class="card">
                                    <div class="card-header" id="headingBorderOne">
                                        <h2>
                                            <a button  class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                                data-target="#collapseBorderOne" aria-expanded="false"
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseBorderOne1" class="collapse" aria-labelledby="headingBorderOne1"
                                        ...
                                        <div class="card-body">
                                            <form action="{{ url('admin_image', $admin->id) }}" method="post"
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseBorderTwo" class="collapse" aria-labelledby="headingBorderTwo"
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('admin_auth.update', $admin->id) }}" method="post"
                                                enctype="multipart/form-data">
                                                @csrf
                                                @method('patch')
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" name="name"
                                                        value="{{ old('admin') ?? $admin->name }}" class=" form-control"
                                                        id="lastName">
                                                </div>
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="email" name="email"
                                                        value="{{ old('admin') ?? $admin->email }}" class="form-control"
                                                        id="email">
                                                </div>
                                                <div class="d-flex justify-content-end mt-6">
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingBorderThree">
                                        <h2 class="mb-0">
                                            <button style="color: rgb(5, 5, 5); text-decoration: none;"
                                            onmouseover="this.style.color='rgb(137,77,217)';"
                                            onmouseout="this.style.color='black';" class="btn btn-link collapsed" type="button" data-toggle="collapse"
